...
import { RemoveItemDiscountCommand } from '../commands/remove-item-discount.command';
...
export class RemoveItemDiscountHandler implements SalesCommandHandler<
...
> {
  ...
  public async execute(
    command: RemoveItemDiscountCommand,
    ...
    try {
      ...
      sale.removeItemDiscount(itemId, this.clock);

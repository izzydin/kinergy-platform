...
export class UpdateSaleItemQuantityHandler implements SalesCommandHandler<
...
> {
  ...
  public async execute(
    command: UpdateSaleItemQuantityCommand,
    ...
    try {
      ...
      sale.updateItemQuantity(input.itemId.trim(), input.newQuantity, this.clock);

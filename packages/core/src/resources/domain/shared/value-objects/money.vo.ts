...
/**
 * Value Object representing commercial, fixed asset, and inventory valuation amounts.
 * Stores non-negative amounts with explicit ISO-4217 currency.
 * Precision: Fixed 2 decimal places (integer cents / hundredths).
 */
export class Money implements ValueObject<MoneyProps> {
  ...
  public multiply(quantity: number | { readonly value: number }): Money {
  ...
  public equals(other: ValueObject<MoneyProps> | undefined | null): boolean {
